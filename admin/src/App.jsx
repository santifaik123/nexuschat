...
const PAGES = { dashboard: Dashboard, conversations: Conversations, knowledge: KnowledgeBase, appearance: Appearance, ai: AISettings, leads: Leads, settings: Settings };
        ...
        <div className="app">
            <aside className="sidebar">
                ...
                <div style={{ padding: '0 16px 12px', borderBottom: '1px solid var(--border)' }}>
                    <div style={{ fontSize: 11, color: 'var(--text-muted)', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Client</div>
                    <select
                        value={tenantId}
                        onChange={e => { setTenantId(e.target.value); setPage('dashboard'); }}
